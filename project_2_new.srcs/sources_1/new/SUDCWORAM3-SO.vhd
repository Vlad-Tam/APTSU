...
component JK_trigger_wrapper is
    Port (
        D       : in STD_LOGIC;
        not_C   : in STD_LOGIC;
        not_R   : in STD_LOGIC;
...
begin
    ...
    R0 <= not ((not not_G) and (((not (not R)) and not_JK4) or ((not R) and (not_JK0))));
    R1 <= not ((not not_G) and (((not (not R)) and not_JK5) or ((not R) and (not_JK1))));
    R2 <= not ((not not_G) and (((not (not R)) and not_JK6) or ((not R) and (not_JK2))));
    R3 <= not ((not not_G) and (((not (not R)) and not_JK7) or ((not R) and (not_JK3))));
